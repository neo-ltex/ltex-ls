			...
			assets: [
				{
					...
					browser_download_url: 'https://github.com/valentjn/ltex-ls/releases/download/16.0.0/ltex-ls-16.0.0-linux-x64.tar.gz'
				},
				{
					name: 'ltex-ls-16.0.0-mac-x64.tar.gz',
					browser_download_url: 'https://github.com/valentjn/ltex-ls/releases/download/16.0.0/ltex-ls-16.0.0-mac-x64.tar.gz'
				},
				{
					name: 'ltex-ls-16.0.0-windows-x64.zip',
					browser_download_url: 'https://github.com/valentjn/ltex-ls/releases/download/16.0.0/ltex-ls-16.0.0-windows-x64.zip'
				},
				{
